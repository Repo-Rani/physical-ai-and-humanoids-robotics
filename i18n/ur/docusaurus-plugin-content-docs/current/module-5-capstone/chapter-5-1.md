...
# باب 5.1: کپسٹون پروجیکٹ کا جائزہ

کپسٹون پروجیکٹ ماڈیولز 0-4 میں سیکھی گئی ہر چیز کو ایک مکمل خودکار انسانی نما نظام میں ضم کرتا ہے۔ یہ باب پروجیکٹ کے دائرہ کار، ضروریات، اور منصوبہ بندی کے طریقہ کار کا تعارف کراتا ہے۔

## 5.1.1 جامع پروجیکٹ کی ضروریات کی تعریف

کامیاب کپسٹون پروجیکٹ کی شروعات واضح، قابل پیمائش ضروریات سے ہوتی ہے جو ترقی اور جائزہ کو رہنمائی دیتے ہیں۔

### فنکشنل ضروریات

اپنے انسانی نما روبوٹ کے لیے یہ تعریف کریں کہ اسے کیا کرنا چاہیے:
...
یہ تعریف کریں کہ نظام کو کتنی اچھی کارکردگی دکھانی چاہیے:
...
پروجیکٹ کے جائزے کے لیے واضح بنچ مارکس قائم کریں:

1. **مینیمم قابل عمل پروڈکٹ (MVP)**:
   - بنیادی ادراک (آبجیکٹ ڈٹیکشن، گہرائی کا احساس)
   - سادہ نیویگیشن (نقطہ سے نقطہ تک حرکت)
   - ایک قسم کی گرفت کی تنصیب
   - آواز کے احکامات کی شناخت (5 احکامات)

2. **ہدف کارکردگی**:
   - ملٹی موڈل ادراک کی یکجائی
   - خودکار نیویگیشن راہ کی منصوبہ بندی کے ساتھ
   - متعدد گرفت کی حکمت عملیاں
   - قدرتی زبان کی سمجھ
   - جذبات کی شناخت

3. **اضافی ہدف**:
   - نافذگی کے دوران ڈائنامک دوبارہ منصوبہ بندی
   - انسانی مظاہرے سے سیکھنا
   - ملٹی ٹاسک کوآرڈینیشن
   - طویل مدتی یادداشت اور ذاتی بنانا

## 5.1.2 مربوط نظام کی آرکیٹیکچر کا ڈیزائن

اچھی طرح ڈیزائن کی گئی آرکیٹیکچر یہ یقینی بناتی ہے کہ تمام اجزاء بآسانی ایک ساتھ کام کریں۔

### نظام کی آرکیٹیکچر کا جائزہ
...
## 5.1.3 ترقیاتی ٹائم لائن کی منصوبہ بندی

پروجیکٹ کو قابل انتظام مرحلوں میں تقسیم کریں جن کے واضح سنگ میل ہوں۔

### 12 ہفتوں کی ترقیاتی ٹائم لائن
...
## 5.1.4 یکجائی کے چیلنجز کی شناخت

عام یکجائی کے مسائل کی پیش گوئی کریں اور ان کے لیے منصوبہ بندی کریں۔
...
## 5.1.5 ٹیسٹنگ اور تصدیق کی حکمت عملیوں کا قیام

جامع ٹیسٹنگ نظام کی اعتمادیت کو یقینی بناتی ہے۔
...
## 5.1.6 ٹیم کی ذمہ داریوں کا انتظام

واضح کردار اور ذمہ داریاں موثر تعاون کو یقینی بناتی ہیں۔
...
## 5.1.7 مناسب ہارڈویئر پلیٹ فارمز کا انتخاب

اپنے پروجیکٹ کی ضروریات اور بجٹ کے مطابق ہارڈویئر کا انتخاب کریں۔

### ہارڈویئر ٹائر کی موازنہ
