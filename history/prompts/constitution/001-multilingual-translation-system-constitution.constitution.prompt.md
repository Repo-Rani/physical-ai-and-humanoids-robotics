---
id: "001"
title: "Multi-Language Translation System Constitution"
stage: "constitution"
date_iso: "2026-01-05"
surface: "agent"
model: "claude-sonnet-4-5-20250929"
feature: "multilingual-translation"
branch: "001-docusaurus-multilingual-chatbot"
user: "HP"
...
links:
  ...
  PR: "null"
files_yaml: |
  - C:\\Users\\HP\\Desktop\\ai-and-humanoid-robotics-hackathon\\hackathon-constitution.md
  - C:\\Users\\HP\\Desktop\\ai-and-humanoid-robotics-hackathon\\.specify\\memory\\constitution.md
tests_yaml: |
  - "None"
outcome: "Successfully created a new constitution file for the multilingual translation system"
evaluation: "Constitution document properly created with all requirements for Urdu/Hindi translation system"
---

# Prompt History Record: Multi-Language Translation System Constitution
...
typescript// src/components/TranslateButton.tsx
...
typescriptLocation: src/components/Navbar or docusaurus.config.mjs
...
typescriptLocation: Start of each chapter (after title, before content)
...
markdownSource: docs/00-introduction/01-welcome.md
...
✓ All import statements (ReadingTime, PersonalizeBu:::tip, :::caution)
...
javascript// docusaurus.config.mjs
export default {
  i18n: {
    defaultLocale: 'en',
    locales: ['en', 'ur', 'hi'],
...
yamlPROTECTED FILES (DO NOT MODIFY):
...
markdown# English: docs/00-introduction/01-welcome.md
---
sidebar_position: 1
...
---
Technical Terms
yamlKeep in English (with translation in parentheses):
  - ROS 2 (ROS 2)
...
markdown- [ ] All English content unchanged
...
yamlRequirements for 50 bonus points:
...
yamlHIGH PRIORITY (Translate First):
...
I created a separate constitution file called `hackathon-constitution.md` that contains all the requirements for implementing the multilingual translation system. The file includes:

1. Complete requirements for the multi-language translation system
2. Detailed UI component specifications (Language Dropdown and TranslateButton)
3. Proper folder structure for i18n support
4. Translation guidelines and technical term handling
5. Docusaurus configuration requirements
6. Critical rules to protect existing files
7. Implementation steps
8. Testing checklist
9. Bonus points criteria
10. File priority map

The document ensures that all existing functionality is preserved while adding the new multilingual capabilities as required for the hackathon project. The file was created without modifying any existing project files.